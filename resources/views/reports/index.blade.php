...
@section('content')
    <div class="page-header mb-4">
        ...
        <p class="text-muted mb-0">Valores reais de vendas, lucros e encerramento de atendimentos</p>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small class="text-muted">Pedidos concluídos / atendimento encerrado</small>
                        </div>
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
            <h5 class="mb-0"><i class="bi bi-table"></i> Por atendimento · Encerrar lança nos lucros</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                        ...
                        <div class="card card-modern h-100 {{ $d['tem_abertos'] ? 'border-warning' : '' }}">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="mb-0 fw-bold">Atend. {{ $mesa }}</h6>
                                    @if ($d['tem_abertos'])
                                        <span class="badge bg-warning text-dark"><i class="bi bi-clock"></i>
                                            Pendências</span>
                                    @elseif($d['concluidos_valor'] > 0)
                                        <a href="{{ route('reports.fechar-venda', $mesa) }}"
                                            class="btn btn-sm btn-success"><i class="bi bi-cash-coin"></i> Fechar
                                            venda</a>
                                    @else
                                ...
                                <p class="small text-success mb-0">Já nos lucros: R$
                                    {{ number_format($d['concluidos_valor'], 2, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                @endfor
