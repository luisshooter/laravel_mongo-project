        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="card card-modern">
                <div class="card-header card-header-modern">
                    <h5 class="mb-0"><i class="bi bi-cart-plus"></i> Cadastrar Pedido – Floricultura</h5>
                </div>
                <div class="card-body">
                    ...
                    <div id="vue-order-app">
                        <form action="{{ route('orders.store') }}" method="POST" @submit="onSubmit">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success shadow-sm">
                                    <i class="bi bi-save"></i> Cadastrar Pedido
                                </button>
                            </div>
                        </form>
                    </div>
