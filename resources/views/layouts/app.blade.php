...
<head>
    ...
    <title>@yield('title', 'Floricultura – Pedidos')</title>
    ...
    <script>
        (function() {
            var t = document.documentElement.getAttribute('data-theme') || localStorage.getItem('restaurante-theme') ||
                'light';
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a class="sidebar-brand" href="{{ route('dashboard') }}">
                    ...
                    <span class="sidebar-brand-text">Floricultura</span>
                </a>
            ...
            <div class="sidebar-footer">
                <div class="sidebar-collapse-row d-none d-lg-flex">
                    <span class="sidebar-label sidebar-collapse-label"><i class="bi bi-layout-sidebar-inset-reverse"></i>
                        Recolher menu</span>
                    <button class="sidebar-collapse-btn" type="button" id="sidebarCollapse"
                        aria-label="Recolher menu para ver só ícones">
        ...
        (function() {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function setCollapsed(collapsed) {
                    ...
                    if (collapseIcon) collapseIcon.className = collapsed ? 'bi bi-chevron-double-right' :
